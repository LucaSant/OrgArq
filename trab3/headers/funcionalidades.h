...
int search_btree(char *tipoArquivo, char* arquivoEntrada, int order); // Funcionalidade [10]
int insert_reg_btree(char *tipoArquivo, char* arquivoEntrada, int order); // Funcionalidade [11]